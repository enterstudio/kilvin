    ...
    */
    private function publishFormCustomField($which, $submission_error, $row, $incoming)
    {
        ...
        if ($row->field_type == 'date')
        {
            ...
            if (isset($incoming[$date_field])) {
                $field_data = $incoming[$date_field];
            }
            ...
            if (!empty($submission_error)) {
                $custom_date = (empty($field_data)) ? '' : Localize::humanReadableToUtcCarbon($field_data);
            } else {
                $custom_date = (empty($field_data)) ? '' : Carbon::parse($field_data);
            }
            ...
            $cal_img =
                '<a href="#" class="toggle-element" data-toggle="calendar_'.$date_field.'">
            ...
            $r .= Cp::input_text(
                ...
                'input',
                '170px',
                'onkeyup="update_calendar(\''.$date_field.'\', this.value);" '
            ).
            $cal_img;

            $r .= '<div id="calendar_'.$date_field.'" style="display:none;margin:4px 0 0 0;padding:0;">';
