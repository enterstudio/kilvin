...
class Templates
{
    ...
    */
    public function editTemplateNames($folder = null)
    {
        ...
        if (Request::input('msg') == 'success') {
            $r .= Cp::quickDiv('success-message', __('templates.template_names_updated'));
        }
    ...
    */
    ...
    public function templateManager()
    {
        ...
        Cp::$crumb = __('templates.template_management');
        ...
        $right_links[] = [
            BASE.'?C=Administration'.AMP.'M=configManager'.AMP.'P=template_preferences'.AMP.'class_override=templates',
        ...
        switch (Request::input('msg'))
        {
            ...
            case '05' : $message = __('templates.template_deleted');
                break;
            case '06' : $message = __('templates.template_updated');
                break;
            default   : $message = '';
                break;
        }
        ...
        {
            $r .= Cp::quickDiv('success-message', __('templates.search_terms').NBS. Request::input('keywords'));
        }
...
$(function() {
    ...
    public function editTemplate($template_id = '', $message = '')
    {
        ...
        <script type="text/javascript">
            ...
            function flipButtonText()
            {
                ...
                if (which == "clear")
                {
                	$('#revisions_button').attr('value', '<?php echo __('cp.clear'); ?>');
                }
                else
                {
                	$('#revisions_button').attr('value', '<?php echo __('cp.view'); ?>');
                }
            }
        ...
        $r .= Cp::input_select_footer()
             .'&nbsp;&nbsp;'
             .Cp::input_submit(__('cp.view'), 'submit', 'id="revisions_button" onclick="return viewRevision();"');
             ...
             '<td>'.PHP_EOL.
                Cp::quickDiv(
                    ...
                    Cp::input_submit(__('cp.update')).
                        NBS.
                        Cp::input_submit(__('cp.update_and_return'),
                    'return')
                ).
             '</td>'.PHP_EOL.
             '</tr>'.PHP_EOL.
    ...
    public function updateTemplate()
    {
        ...
        if (Request::has('return')) {
            return redirect('?C=templates'.'&msg=06');
        }
